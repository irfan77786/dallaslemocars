...
@section('content')
    <main>
        <section
            class="home-banner-section position-relative pt-40 pt-sm-60 py-md-70 py-lg-100 d-flex align-items-center"
                ...
                <div class="row">
                    <div class="col-12 col-md-6 d-flex flex-column justify-content-center text-center text-md-start">
                        ...
                        <p class="font-md text-white d-flex align-items-center justify-content-center justify-content-md-start">
                            Call Now: <a href="tel:+12148978056" class="fw-bold font-lg text-white mx-2 text-underline">(214) 897-8056</a>
                        </p>
                    </div>
