...
[
'text' => 'Free 30 min wait time for airport pickups and 15 min for all others',
'icon' => 'bi-clock',
...
['text' => 'Free Cancellation 24 hours before pickup', 'icon' => 'bi-x-circle']
];
@endphp
...
<div class="container py-5">
  <div class="row">
    <div class="col-md-8 px-4 mb-3 mobile-mg-dc">
      <form method="POST" action="{{ url('/bookRide') }}" class="d-flex flex-column loader-form">
        ...
        <input type="hidden" name="return_service" id="hidden-return-service" value="{{ session('return_service', 0) }}">
        <input type="hidden" name="return_pickup_location" id="hidden-return-pickup-location" value="{{ session('return_pickup_location') }}">
        <input type="hidden" name="return_dropoff_location" id="hidden-return-dropoff-location" value="{{ session('return_dropoff_location') }}">
        <input type="hidden" name="return_pickup_date" id="hidden-return-pickup-date" value="{{ session('return_pickup_date') }}">
        <input type="hidden" name="return_pickup_time" id="hidden-return-pickup-time" value="{{ session('return_pickup_time') }}">
        <input type="hidden" name="return_flight_number" id="hidden-return-flight-number" value="{{ session('return_flight_number') }}">
        <input type="hidden" name="return_flight_details" id="hidden-return-flight-details" value="{{ session('return_flight_details') }}">
        <input type="hidden" name="return_no_flight_info" id="hidden-return-no-flight-info" value="{{ session('return_no_flight_info', 0) }}">
  ...
  <div class="form-group mb-3">
    <div class="input-group-container" style="margin-bottom: 2px !important;">
      ...
      <div class="input-text-container">
        <div class="input-group">
          <input type="text" id="pickup-flight-details" name="pickup_flight_details"
            class="form-control custom-input-style info-line-style"
            placeholder="Enter pickup flight details"
            value="{{ session('pickup_flight_details') ?? '' }}">
        </div>
      </div>
    </div>
    <p class="text-muted my-0 ml-0 small mb-3">
      Example: American Airlines, Flight 123, Arriving at 3:00 PM
    </p>
  </div>
  ...
  <div class="form-group">
    <div class="input-group-container" style="margin-bottom: 2px !important;">
      <div class="icon-container">
        <i class="bi bi-123" style="font-weight: bold;"></i>
      </div>
      <div class="input-text-container">
        <div class="input-group">
    ...
    <p class="text-muted my-0 ml-0 small mb-3">Example: AA123</p>
  </div>
  ...
  <div class="form-group">
    <div class="input-group-container" style="margin-bottom: 2px !important;">
      ...
      <div class="input-text-container">
        <div class="input-group">
          <select class="form-control custom-input-style" id="meet-option" name="meet_option">
    ...
    <p class="text-muted my-0 ml-0 small mb-3">Select where you'd like to meet your driver</p>
  </div>
        ...
        <div>
          ...
          <div class="form-group">
            <div style="margin-bottom: 2px !important;">
              <div class="input-text-container">
                <div class="input-group">
                    <textarea id="note" name="note" class="custom-input-style" placeholder="Notes for the Chauffeur" rows="1" style="background-color: #EEEFF1 !important; border: none; border-radius: 4px">{{ session('note') ?? '' }}</textarea>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-weight-bold" id="returnReservationModalLabel">Return Reservation</h5>
      ...
      <form id="return-service-form" method="POST" action="{{ url('/save-return-service') }}" class="loader-form">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6" style="position:relative;">
              <div id="modal-map" style="height: 500px; width: 100%; border-radius: 15px; background-color: #f0f0f0;"></div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group-container  mb-3">
                ...
                <div class="input-text-container">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" value="{{ session('return_pickup_location') }}" name="return_pickup_location" id="return-pickup-location" placeholder="Address, Airport, Hotel..." onfocus="geolocate()" required>
                  </div>
                </div>
              </div>
              ...
              <div class="input-group-container  mb-3">
                ...
                <div class="input-text-container">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="return_dropoff_location" id="return-dropoff-location" value="{{ session('return_dropoff_location') }}" placeholder="Address, Airport, Hotel..." onfocus="geolocate()" required>
                  </div>
                </div>
              </div>
              ...
              <div class="input-group-container  mb-3">
                ...
                <div class="input-text-container">
                  ...
                  <div class="input-group">
                    <div class="ph-wrap">
                      <input type="date" class="form-control" name="return_pickup_date" id="return-pickup-date"
                        value="{{ session('return_pickup_date', '') }}" placeholder="MM-DD-YYYY" required>
              ...
              <div class="input-group-container  mb-3">
                ...
                <div class="input-text-container">
                  ...
                  <div class="input-group">
                    <div class="ph-wrap">
                      <input type="time" class="form-control" name="return_pickup_time" id="return-pickup-time"
                        value="{{ session('return_pickup_time') }}" placeholder="HH:MM AM" required>
              ...
              <div class="mb-4" id="flight-info-section">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                    <div class="input-group-container ">
                      ...
                      <div class="input-text-container">
                        <label for="return-flight-details" class="form-label">Pickup Flight Details (Recommended)</label>
                        <div class="input-group">
                          <input type="text" id="return-flight-details" name="return_flight_details" class="form-control custom-input-style" placeholder="Enter pickup flight details" value="{{ session('return_flight_details') }}">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 form-group">
                    <div class="input-group-container">
                      ...
                      <div class="input-text-container">
                        <label for="return-flight-number" class="form-label">Flight Number</label>
                        <div class="input-group">
                          <input type="text" id="return-flight-number" name="return_flight_number" class="form-control custom-input-style" placeholder="Enter flight number" value="{{ session('return_flight_number') }}">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-check mt-3 d-flex pl-5">
                  <input type="checkbox" class="form-check-input" id="return-no-flight-info" {{ session('return_no_flight_info') == 1 ? 'checked' : '' }} name="return_no_flight_info" value="1" style="position:static">
              ...
              <button type="button" class="btn btn-primary btn-sm w-100 toggle_vehicleSelect">SELECT VEHICLE</button>
            </div>
          </div>
          <div class="row">
                ...
                <div class="col-12">
                  <div class="vehical-card p-3 mb-3 row text-left text-md-left align-items-center justify-content-center border-bottom" style="border-color: #8b8b8b;">
                    ...
                    <div class="col-12 col-md-4 mb-3 d-flex flex-column align-items-center">
                      ...
                      <div class="row justify-content-md-center justify-content-start mt-3 w-100">
                        <div class="col-4 col-md-6 text-md-center d-flex align-items-md-center justify-content-md-center align-items-start justify-content-start text-left mb-2">
                          <img src="/image/user.svg" alt="Passengers" class="mr-2" style="height:20px;width:20px;">
                          <p class="mb-0 small">Max. {{ $value->number_of_passengers }}</p>
                        </div>
                        <div class="col-4 col-md-6  d-flex text-md-center align-items-md-center justify-content-md-center text-left align-items-start justify-content-start mb-2">
                          <img src="/image/bag.svg" alt="Luggage" class="mr-2" style="height:20px;width:20px;">
                    ...
                    <div class="col-12 col-md-4 mb-2 d-flex flex-column align-items-start align-items-md-end text-left text-md-right">
                      ...
                      <div class="car-price font-weight-bold">
                        <h4 class="mb-1">${{ number_format($vehicleDistance['price'], 2) }}</h4>
                        <br><small>Total Distance: {{ number_format($vehicleDistance['distance_km'], 2) }} Miles</small>
                      </div>
                      <div class="mb-2">
                        <small class="text-muted font-weight-bold">Includes base fare, gratuity & tax</small><br>
                        <small class="text-muted">No hidden costs.</small>
                      </div>
                      <a href="javascript:void(0)" data-vehicle-id="{{ $value->id }}" class="select-vehicle btn btn-primary btn_dark mt-2 trigger-loader">
                        SELECT
                      </a>
                      @else
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="save-return-service">Save Return Service</button>
        </div>
      </form>
    </div>
  </div>
  ...
  jQuery(document).ready(function() {
    ...
    setTimeout(function() {
      ...
      if (modalMapContainer) {
        ...
        modalMapContainer.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #666; background-color: #f0f0f0;"><i class="bi bi-geo-alt" style="font-size: 2rem; margin-right: 10px;"></i>Map Container Ready</div>';
      } else {
    ...
    function initializeEmptyModalMap() {
      ...
      if (modalMapElement && typeof google !== 'undefined' && google.maps) {
        ...
        modalMapElement.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #666; background-color: #f0f0f0;"><i class="bi bi-geo-alt" style="font-size: 2rem; margin-right: 10px;"></i>Loading map...</div>';
    ...
    $('#returnReservationModal').on('shown.bs.modal', function() {
      ...
      const modalMapElement = document.getElementById('modal-map');
      if (modalMapElement) {
        modalMapElement.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #666; background-color: #f0f0f0;"><i class="bi bi-arrow-clockwise" style="font-size: 2rem; margin-right: 10px; animation: spin 1s linear infinite;"></i>Updating map...</div>';
      }
    ...
    function updateModalMap() {
      ...
      if (pickupLocation && dropoffLocation) {
        ...
        if (modalMapElement) {
          modalMapElement.innerHTML = '<div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #666; background-color: #f0f0f0;"><i class="bi bi-geo-alt" style="font-size: 2rem; margin-right: 10px;"></i>Enter pickup and dropoff locations to see the route</div>';
        }
      }
    }
    ...
    $('#return-service-form').on('submit', function(e) {
      ...
      if (returnPrice) {
        ...
        formData.append('return_per_km_rate', sessionStorage.getItem('return_per_km_rate') || '0');
      ...
      jQuery.ajax({
        ...
        complete: function() {
          // Reset button state
          $('#save-return-service').prop('disabled', false).text('Save Return Service');
        }
      });
    });
