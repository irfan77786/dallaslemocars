            ...
            <div class="row justify-content-center">
                <div class="text-center col-12 col-lg-11 col-xl-10 mb-25 mb-md-30 mb-lg-40">
                    <h2 class="h2 fw-bold mb-15 mb-sm-20 mb-lg-30 seciononeheading">Top Cities & <span class="theme-color">Top
                            Routes</span></h2>
                    <p class="font-base">Our DFW car service connects you to the most popular cities and travel routes across North Texas. Whether you're heading to Dallas, Arlington, Plano, Frisco, Irving, or nearby destinations, our professional chauffeurs ensure smooth, punctual, and comfortable transportation. Enjoy reliable airport car service to and from DFW with luxury vehicles, private travel, and a stress-free ride experience every time.</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                      ...
                      <div class="row">
                           <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                            <p class="mb-0 text-white font-base">24 miles &nbsp;&nbsp;|&nbsp;&nbsp; 34m</p>
                             </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                        ...
                        <div class="city-details p-15 position-absolute">
                           ...
                           <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                            <p class="mb-0 text-white font-base">25 miles &nbsp;&nbsp;|&nbsp;&nbsp; 36m</p>
                             </div>
                            </div>
                    ...
                    <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                        ...
                        <div class="city-details p-15 position-absolute">
                           ...
                           <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                            <p class="mb-0 text-white font-base">8 miles &nbsp;&nbsp;|&nbsp;&nbsp; 16m</p>
                             </div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                        ...
                        <div class="city-details p-15 position-absolute">
                           ...
                           <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                            <p class="mb-0 text-white font-base">13 miles &nbsp;&nbsp;|&nbsp;&nbsp; 22m</p>
                             </div>
                            </div>
                        </div>
                    </article>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                        ...
                        <div class="city-details p-15 position-absolute">
                              <div class="row">
                           <div class="col-md-6 col-sm-6">
                            <h3 class="mb-1 text-white h6">Fort Worth
                                <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-style-nw1xan"
                                    focusable="false" aria-hidden="true" width="20" viewBox="0 0 24 24"
                                    data-testid="ChevronRightIcon">
                                    <path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" fill="#fff"></path>
                            ...
                            <div class="col-md-6 col-sm-6">
                            <p class="mb-0 text-white font-base">24 miles &nbsp;&nbsp;|&nbsp;&nbsp; 32m</p>
                             </div>
                            </div>
                        </div>
                    </article>
